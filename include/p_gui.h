...
extern void gui_fb_draw_surface(int dst_x, int dst_y, surface_st *src_sf, rect_st src_rect, int mark_dirty);
extern void gui_fb_draw_tiles(rect_st rect, bitmap_st *bmp);
...
extern int gui_wm_is_valid_tile(bitmap_st *b);
